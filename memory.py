...
class Memory:
    def __init__(self, number=8, wid=1090, hei=630):
        ...
        self.label = Label(self.root, text="", font=("Times New Roman", 30), bg='white', fg='#404040')
        self.label.pack(anchor=NE)
        self.label_player1 = Label(self.root, text=" ", font=("Times New Roman", 30),
                                   bg='white',borderwidth=3,relief='groove', fg='#404040')
    ...
    def update_label(self):
        self.label_player1[
            "text"] = f"Игрок 1 - Очки: {self.players[0]['points']},\n Попытки: {self.players[0]['chances']}"
        self.label_player2[
            "text"] = f"Игрок 2 - Очки: {self.players[1]['points']},\n Попытки: {self.players[1]['chances']}"
